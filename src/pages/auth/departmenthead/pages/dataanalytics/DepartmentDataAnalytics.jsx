...
import DepartmentCompletionChart from "../dashboard/DepartmentCompletionChart";
...
const MetricCard = ({ item, colors }) => {
  ...
  return (
    <div
      className={`rounded-xl border p-2 ${colors.border} ${colors.bg}`}
    >
      {/* Icon */}
...
const OverviewTab = () => {
  return (
    <div className="space-y-6 md:px-2">
      {/* Top stats */}
      <div className="border border-gray-200 rounded-xl bg-sidebar p-2 md:p-6">
...
export default DepartmentDataAnalytics;
