...
import { ClipboardList, Award, Clock, Heart, CheckCircle2 } from "lucide-react";
...
const EmployeeCourseDetail = () => {
  ...
  return (
    <div className="p-2 md:p-6 w-full mx-auto ">
      <div className="space-y-6 border border-gray-100 rounded-xl p-1 xl:p-4">
        {/* BACK */}
        <div className="flex flex-col md:flex-row justify-between items-center text-[#45556C]  p-2 border-b border-gray-100 text-sm">
          <div className="w-full md:w-3/5 2xl:w-4/5 flex justify-start items-start gap-2">
          ...
          <div className="w-full md:w-2/5 2xl:w-1/5 flex justify-end xl:justify-between items-center gap-4 mt-2 md:mt-0">
              <p className="font-medium">8/12/2024</p>
                <p className="font-medium">1 Week</p>
                <p
                  className={`px-4 py-1.5 rounded-full text-xs xl:text-sm font-medium bg-green-50 text-green-600`}
                >
        ...
        <div className="w-full grid sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-4 2xl:gap-8">
          <div className="w-full min-w-[230px] bg-[#DBC9F8]/40 border border-gray-200 rounded-xl p-4 space-y-4 ">
            {/* Thumbnail */}
        ...
        <div className="w-full  rounded-xl border border-gray-100 p-6 space-y-6 overflow-x-auto">
          <div className="flex justify-between items-center pb-2 lg:pb-0 border-b border-gray-100 lg:border-none">
            <h3 className="font-semibold text-neutral-900 text-xl">
              {" "}
              Course Modules
            </h3>
          </div>
          <div className="hidden lg:flex justify-between items-center text-[#45556C] font-medium py-2 border-b border-gray-100 px-4 text-sm">
