...
const EmployeeNavbar = ({toggleSidebar ,  assesstment= false}) => {
  const type = "Employee";
  ...
  return (
    <div className="flex justify-between items-center py-2 px-6 bg-[#F0F1F5]">
      {assesstment ? ( <div>
        <img src={images.BlackHeartsyLogo} alt="Heartsy" className="w-full max-w-[60px]" />
        </div> ):
      (
