...
import AddDepartmentModal from "./AddDepartments";
     ...
     <div className="relative flex-1 p-4 md:p-6">
      ...
      <div className="md:hidden flex justify-between items-center ">
        ...
        <div className="flex items-center gap-2">
            ...
            <button className="bg-primary text-white px-2 py-2 text-sm rounded-lg" onClick={() => setOpenAddDepartmentModal(true)}>
              Add New Department
            </button>
          </div>
      </div>
      <div className="flex flex-col md:flex-row justify-between items-center mb-8 ">
        ...
        <div>
          <div className="hidden md:flex items-center gap-2">
            ...
            <button className="bg-primary text-white px-4 py-2 rounded-lg" onClick={() => setOpenAddDepartmentModal(true)}>
              Add New Department
            </button>
          </div>
        </div>
