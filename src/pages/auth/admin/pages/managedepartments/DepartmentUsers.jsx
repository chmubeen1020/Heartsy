    ...
    <div className="relative flex-1 p-4 md:p-6">
      ...
      <div className="md:hidden flex justify-between items-center ">
        ...
        <div className="flex items-center gap-2">
          <div className=" border border-gray-200 px-2 py-2 text-sm rounded-lg font-medium flex items-center gap-2">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center mb-8 ">
        ...
        <div className="flex items-center space-x-4 w-full max-w-xs md:max-w-sm mt-4 md:mt-0">
          <div className="relative w-full text-primary">
            <Search
              size={16}
              className="absolute right-3 top-1/2 transform -translate-y-1/2 text-primary bg-transparent"
            />
            <input
              type="text"
