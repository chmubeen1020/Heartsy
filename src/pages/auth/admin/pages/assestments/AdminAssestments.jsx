    ...
    <div className="relative flex-1 p-4 md:p-6">
      ...
      <div className="space-y-2">
        ...
        <div className="border border-gray-200 rounded-xl px-4 py-2">
          ...
          <Link to={`details/1`} className="text-xl font-medium text-primary">{data.heading2}</Link>
      ...
      <div className="flex justify-center items-center mt-4">
          <div className="flex space-x-2 md:space-x-4">
            ...
            >
              ...
              <button
                className={`px-2 md:px-4 border py-2 font-medium rounded-md border-gray-400`}
              >
                1
              </button>
              <button
...
export default AdminAssestments;
