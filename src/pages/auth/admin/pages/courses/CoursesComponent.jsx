          ...
          {COURSE_DATA.map((course) => (
            ...
            >
              ...
              <div className="col-span-1 md:col-span-2 text-right">
                <button className="w-full md:w-auto px-4 py-2 bg-primary text-white text-sm font-semibold rounded-lg hover:opacity-90 transition-all " onClick={() => setOpenRecomendCourseModal(true)}>
                  Recommend
                </button>
              </div>
            </div>
