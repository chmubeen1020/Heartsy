...
export default function AdminSignup() {
 ...
 const CreateAccount = () => {
  navigate("/auth/admin/account-setup");
};
      ...
      <div className="relative min-h-screen flex justify-end items-center">
        ...
        <div className="w-full max-w-xl px-10">
          ...
          <div className="space-y-5 mt-6">
            ...
            {/* Login Button */}
            <button className="w-full bg-primary hover:bg-primaryDark text-white py-3 rounded-lg font-medium transition" onClick={CreateAccount}>
              Create Account
            </button>
            ...
            <div className=" text-xs text-gray-400 flex items-center justify-center gap-2 pt-10">
                <p>Already have and account ?</p> 
                <a href="/auth/admin/login" className="text-primary"> Sign in</a></div>
          </div>
        </div>
        </div>
      </div>
